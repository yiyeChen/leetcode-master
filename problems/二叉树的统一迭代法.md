...
The idea is to use a NULL element to indicate that the previous element can be printed.

Otherwise (w/o NULL), the node is just added to be checked, not to be printed.
